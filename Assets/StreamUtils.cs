...
namespace Xingyu.Tools
{
	...
	{
		//		static System.Text.Encoding DefaultEncoding = System.Text.Encoding.GetEncoding("GB2312");
		...
		public static String Read(Stream s, out String value, params int[] count)
		{
			...
			//value = PlatformTools.BS2String_UTF8(strBuf, 0, strBuf.Length);
			return value;
		}
